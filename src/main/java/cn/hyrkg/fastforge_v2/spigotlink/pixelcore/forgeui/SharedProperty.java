...
public class SharedProperty {
	...
	public JsonElement get(String key) {
		if (propertyHashMap.containsKey(key))
			return propertyHashMap.get(key).completeJson;
	...
	/**
	 * ####################################################################
	 * Convenient Method Addition 便捷功能
	 * ####################################################################
	 */
	...
	public <T extends PropertyShader> List<T> getListFromArray(String key, Class<T> clazz) {
		...
		return getListFromArray(getCompleteJson().get(key), clazz);
//		
...
//		return list;
	...
	public <T extends PropertyShader> List<T> getListFromArray(JsonElement element, Class<T> clazz) {
